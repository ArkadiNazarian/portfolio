        ...
        <div>
            ...
            <div className="tw-mt-20 tw-text-xl tw-grid tw-grid-cols-6">
                <code className="tw-col-start-2 tw-col-span-4">
                    ...
                    <br />
                    <span className="tw-text-code"> code </span><span className="tw-text-secondary"> : </span> <span className="tw-text-curlybrackets"> [ </span><span className="tw-text-property">"Typescript",</span><span className="tw-text-property">"Javascript",</span><span className="tw-text-property">"React.js",</span><span className="tw-text-property">"Html",</span><span className="tw-text-property">"Tailwind Css",</span><span className="tw-text-property">"Css"</span> <span className="tw-text-curlybrackets"> ],</span>
                    <br />
