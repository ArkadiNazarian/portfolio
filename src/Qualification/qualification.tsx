    ...
    return (
        <div>
            <div className="tw-text-center ">
                ...
                <p className="tw-text-xl tw-text-third">My personal journey</p>
            </div>
            <div className="tw-grid tw-grid-cols-7">
                ...
                <div className="tw-flex tw-flex-col tw-col-start-3">
                    ...
                    <p className="tw-text-sm tw-text-third"><FaCalendarAlt className="tw-text-primary"/>  2021 - present</p>
                </div>
                
                <div className="tw-flex tw-flex-col tw-col-start-5">
                    <p className="tw-text-base tw-text-secondary">Frontend Web Developer </p><br/>
                    <p className="tw-text-base tw-text-third"><FaBuilding className="tw-text-primary"/>  TeamHive </p><br/>
                    <p className="tw-text-sm tw-text-third"><FaCalendarAlt className="tw-text-primary"/>  2021 - present</p><br/>
                    <p className="tw-text-sm tw-text-third"><ImLocation className="tw-text-primary"/>  Helsinki-Finland</p>
                </div>
                <div className="tw-flex tw-flex-col tw-col-start-3">
                    <p className="tw-text-base tw-text-secondary">Math and Physics Diploma</p><br/>
                    <p className="tw-text-sm tw-text-third"><FaCalendarAlt className="tw-text-primary"/>  2018 - 2021</p>
                </div>
                <div className="tw-flex tw-flex-col tw-col-start-5 tw-col-end-7">
                    <p className="tw-text-base tw-text-secondary">QA Automation Testing with Cypress</p><br/>
                    <p className="tw-text-base tw-text-third"><FaBuilding className="tw-text-primary"/>  TeamHive </p><br/>
                    <p className="tw-text-sm tw-text-third"><FaCalendarAlt className="tw-text-primary"/>  2021 - present</p><br/>
                    <p className="tw-text-sm tw-text-third"><ImLocation className="tw-text-primary"/>  Helsinki-Finland</p>
                </div>
