...
export const Skills = () => {
    ...
    return (
        <div className="tw-pt-20 ">
            ...
            <div className={`tw-flex tw-flex-row tw-justify-center tw-transition-all tw-duration-[1000ms] ${isCollapsed ? "tw-h-[35rem]" : "tw-h-64"}`}>
                ...
                <div className="tw-ml-10">
                    ...
                    <p className={`tw-flex laptop:tw-text-base tablet:tw-text-sm tw-text-purple tw-transition-all tw-duration-1000 ${otherisCollapsed ? "tw-opacity-100" : "tw-opacity-0"}`}>GitHub</p>
                    <p className={`tw-flex laptop:tw-text-base tablet:tw-text-sm tw-text-purple tw-transition-all tw-duration-1000 ${otherisCollapsed ? "tw-opacity-100" : "tw-opacity-0"}`}>GitLab</p>
                    <p className={`tw-flex laptop:tw-text-base tablet:tw-text-sm tw-text-purple tw-transition-all tw-duration-1000 ${otherisCollapsed ? "tw-opacity-100" : "tw-opacity-0"}`}>Vercel</p>
                    <p className={`tw-flex laptop:tw-text-base tablet:tw-text-sm tw-text-purple tw-transition-all tw-duration-1000 ${otherisCollapsed ? "tw-opacity-100" : "tw-opacity-0"}`}>Postman</p>
